...
<body>
    ...
    <form class="profile-box" action="myProfileUpdate.php" method="POST" >
    <div class="">
        <h1>My Profile</h1>
        <div class="profile-item">
            <label>Name:</label>
            <input class="inpField" type="text" name="Name" placeholder="<?php echo htmlspecialchars($user['Name']) ?>" required />
        </div>
        <div class="profile-item">
            <label>Street Address:</label>
            <input class="inpField" type="text" name="St_Address" placeholder="<?php echo htmlspecialchars($user['St_Address']) ?>" required />
        </div>
        <div class="profile-item">
            <label>NIC:</label>
            <span id="profile-nic" name="NIC" id="NIC" ><?php echo htmlspecialchars($user['NIC']) ?></span>
        </div>
        <div class="profile-item">
            <label>Course:</label>
