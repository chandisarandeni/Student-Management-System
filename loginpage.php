...
<body>
    ...
    <nav class="navbar">
        <div class="navdiv">
            ...
            <ul>
                ...
                <li><button><a href="signupPage.php">SignUp</a></button></li>
                <li><button><a href="loginPage.php">LogIn</a></button></li>
            </ul>
        </div>
    </nav>
    <br>
    ...
    <div class="login-box">
        ...
        <form action="login.php" method="POST">
            ...
            <input type="text" id="" name="NIC" required>
            <label for="Branch">Branch</label>
            <select class="option-box" id="" name="Branch" required>
